export const getComponents = async includeDeleted => {
    const url = new URL('/v1/components', "http://192.168.1.100:9999");
...
export const getComponentsByID = async id => {
    const url = new URL(`/v1/components/${id}`, "http://192.168.1.100:9999");
...
export const updateComponent = async payload => {
    const url = new URL(`/v1/components/${payload.id}`, "http://192.168.1.100:9999");
