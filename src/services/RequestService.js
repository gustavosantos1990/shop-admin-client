export const getRequests = async (start, end) => {
    const url = new URL('/v1/requests', "http://192.168.1.100:9999");
...
export const getRequestByID = async id => {
    const url = new URL(`/v1/requests/${id}`, "http://192.168.1.100:9999");
...
export const updateRequest = async payload => {
    const url = new URL(`/v1/requests/${payload.id}`, "http://192.168.1.100:9999");
...
export const updateRequestStatus = async (id, desiredStatus) => {
    const url = new URL(`/v1/requests/${id}/status/${desiredStatus}`, "http://192.168.1.100:9999");
